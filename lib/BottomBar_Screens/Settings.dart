...
class _SettingsState extends State<Settings> {
  final List<String> texts = ['Change password', 'My card', 'Transaction limit', 'Notification On / Off','Delete account'];

  final List<String> icons = ['assets/lock.svg', 'assets/card.svg', 'assets/Exchange.svg', 'assets/Notification.svg','assets/delete.svg',];
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          SizedBox(height: 10,),
          Text('+41 123 456 789',style: TextStyle(fontSize: 16,color: Colors.grey),),
          SizedBox(height: 10,),
          Text('example@gmail.com',style: TextStyle(fontSize: 16,color: Colors.grey),),
          Flexible(
            child: ListView.builder(
              itemCount: texts.length, // Set the number of items in the list, including the divider
                  ...
                  return Column(
                    children: [
                      ListTile(
                        ...
                        title: Text(texts[index]),
                        trailing: texts[index]=='Notification On / Off' ? Switch(
                value: isSwitched1,
